...
${ASTRA_SIM} \
    --workload-configuration=${SCRIPT_DIR}/allreduce_256/allreduce \
    ...
    --logical-topology-configuration=${SCRIPT_DIR}/inputs/logical_256_nodes_2D.json \
    --network-configuration=../../../ns-3/scratch/config/config_256_nodes_32_switch_topology.txt \
