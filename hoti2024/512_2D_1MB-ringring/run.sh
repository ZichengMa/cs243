...
${ASTRA_SIM} \
    --workload-configuration=${SCRIPT_DIR}/allreduce_512/allreduce \
    ...
    --logical-topology-configuration=${SCRIPT_DIR}/inputs/logical_512nodes_2D.json \
    --network-configuration=../../../ns-3/scratch/config/config_512_nodes_32_switch_topology.txt \
