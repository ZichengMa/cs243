...
${ASTRA_SIM} \
    --workload-configuration=${SCRIPT_DIR}/allreduce_1024/allreduce \
    ...
    --logical-topology-configuration=${SCRIPT_DIR}/inputs/logical_1024nodes_2D.json \
    --network-configuration=../../../ns-3/scratch/config/config_1024_nodes_64_switch_topology.txt \
